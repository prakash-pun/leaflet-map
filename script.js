var map = L.map("map", {
   zoomControl: true,
}).setView([28.213248, 83.9876608], 15); // leaflet plugin with the variable = map
...
// var marker = L.marker([28.213248, 83.9876608]).addTo(map); 
...
var control = L.Routing.control({
   // adding waypoints to the route in the control = variable
   waypoints: [
      // L.latLng(splitfirst, splitsecond),
      // L.latLng(last1, last2),
   ...
   // unknown address with latitude and longitude -> "N38.1086, W122.1762"
